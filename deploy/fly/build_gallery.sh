...
examples=(chatbot training_dashboard diffusion poster upload_classify object_detection charts stocks prettymap map_poster grc_map audio_analysis gpx_viewer)
